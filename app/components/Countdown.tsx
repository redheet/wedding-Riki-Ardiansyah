...
const CountdownComp: React.FC = () => {
  ...
  return (
    <section id="countdown">
      <div className="min-h-screen bg-[url('/images/countdown/1.webp')] bg-cover bg-[44.5%] text-white relative py-28 flex items-end">
        ...
        <div className="relative py-8 px-10 w-full">
          ...
          <div className="relative z-20">
            <RevealWrapper duration={1500} origin="right">
              ...
              <h1 className="text-3xl font-light mt-2 mb-4">Riki Ardiansyah & Silvia</h1>
